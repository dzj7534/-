...
public class ShowStudentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        isPingfen = req.getParameter("isPingfen");
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
    {
        try {
            ...
            int user_id = LoginServlet.user_id;
            String sql = "SELECT message.message_id,submission_time,content,state,meaning,words,satisfaction FROM message inner JOIN feedback on message.message_id =feedback.message_id INNER JOIN sort on sort.sort_id = message.sort_id where message.user_id = '"+user_id+"' order by submission_time desc";
